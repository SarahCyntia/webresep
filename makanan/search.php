...
$sql = "SELECT*FROM resep WHERE nama_resep LIKE '%" . $cari . "%'";
        ...
        <section id="Internasional">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="resep-card">
                   ...
                   <img src="<?php echo $row['image_resep'] ?>" alt="">
                    <!-- <img src="gambar/Resep-Spagetti-aglio-olio.jpg" alt="spaghetti-aglio e-olio"> <br> -->
                    <a href="page_resep.php?nama_resep=<?php echo $row["nama_resep"] ?>&resep_id=<?php echo $row["resep_id"] ?>"
                        <?php echo $row["nama_resep"] ?> class="button">Lihat Resep</a>
                </div>
            <?php } ?>
